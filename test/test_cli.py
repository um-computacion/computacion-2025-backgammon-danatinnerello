...
from core.excepcions import MovimientoInvalidoError, SacarFichaError, EntradaInvalidaError
...
class TestCLI(unittest.TestCase):
    ...
    def test_movimiento_normal_valido(self):
        ...
        with patch("core.game.Juego.valida_mover_ficha", return_value=(False, [1])): # <--- CAMBIO AQUÍ
    ...
    def test_movimiento_normal_captura(self):
        ...
        with patch("core.game.Juego.valida_mover_ficha", return_value=(True, [1])): # <--- CAMBIO AQUÍ
    ...
    def test_movimiento_invalido_fuera_de_rango(self):
        ...
        self.assertTrue(any("Error: Movimiento o destino inválido" in line for line in salida))
    ...
    def test_opcion_invalida_numerica_lanza_error(self):
        ...
        salida = self.run_cli_with_inputs(["Dana", "abi", "1", "1", "24", "23", "99", "3"])
    ...
    def test_opcion_invalida_numerica_lanza_error(self):
        with patch("core.game.Juego.valida_mover_ficha", return_value=(True, [1])):
            ...
            # - Tercer Menú: "3" (Salir)
            salida = self.run_cli_with_inputs(["Dana", "abi", "1", "10", "11", "99", "3"])
